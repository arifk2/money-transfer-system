...
public class Utility {
	 ...
	 * @param noOfDays days need to add
	 */
	 ...
	 * 
	 * 
	 * @param dateParam date object are parameter
	 ...
	 * Method is written to parse the date string to date Object with time
	 * 
	 * @param dateParam date in string format
	 * @return Date date object with time
	 * @throws ApplicationCustomException application custom exception message
	 * @throws NoSuchMessageException     no available properties error message
	 */
	...
	/**
	 * This method is for the parse date string to convert in to java 7 Date class
	 * object by using java 8 API.
	 * 
	 * 
	 * @param dateParam
	 * @return
	 ...
	 * @param timeInMilise timeStampMilise of time.
	 * @return
	 */
